...
console.log("Optimista", optimista(matriz));
console.log("Pesimista", pesimista(matriz));
console.log("Hurwicz", hurwicz(matriz, coheficiente));
console.log("Savage", savage(matriz));
*/
// resp =  laPlace(matriz);            
// console.log(resp);
...
function hurwicz( matriz, coheficiente ){
    ...
    for (let i = 0; i < matriz.length; i++) {
        ...
        valor[i] =  Math.round((mayor * coheficiente) + (menor * ( 1 - coheficiente)) * 100) / 100;
...
function savage( matriz ){
    ...
    for (let i = 0; i < matriz.length; i++) {
        for (let j = 0; j < matriz[i].length; j++) {
            valorMatriz[i][j] = mayor[i] - matriz[i][j];
        }
    }
